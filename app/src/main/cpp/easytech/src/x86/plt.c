...
bss(_ZZN9CActionAI8InstanceEvE10S_ActionAi, 56)
...
bss(_ZZN13CActionAssist8InstanceEvE14S_ActionAssist, 6316)
...
void __attribute__((visibility("hidden"))) resolvesymbol() {
    ...
    off(_ZplRK11TiXmlStringS1_, 836144)
    off(_ZplRK11TiXmlStringPKc, 836304)
    off(_ZplPKcRK11TiXmlString, 836464)
    ...
    off(_ZlsR14TiXmlOutStreamRK9TiXmlNode, 853888)
