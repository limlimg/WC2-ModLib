...
bss(_ZGVZN9CActionAI8InstanceEvE10S_ActionAi, 4)
...
bss(_ZGVZN13CActionAssist8InstanceEvE14S_ActionAssist, 4)
...
void __attribute__((visibility("hidden"))) resolvesymbol() {
    ...
    off(_ZplRK11TiXmlStringS1_, 528953)
    off(_ZplRK11TiXmlStringPKc, 529017)
    off(_ZplPKcRK11TiXmlString, 529089)
    ...
    off(_ZlsR14TiXmlOutStreamRK9TiXmlNode, 536189)
